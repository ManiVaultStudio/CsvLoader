...
class CsvLoaderConan(ConanFile):
    ...
    name = "CsvLoaderPlugin"
    description = "Load CVS encoded data into the HDPS framework. "
    topics = ("hdps", "plugin", "data", "csv loader")
    url = "https://github.com/hdps/CsvLoader"
    ...
    def _configure_cmake(self):
        cmake = CMake(self)
        cmake.configure(build_script_folder="hdps/CsvLoader")
        cmake.verbose = True
        return cmake
    ...
    def build(self):
        ...
        # The CsvLoader build expects the HDPS package to be in this install dir
